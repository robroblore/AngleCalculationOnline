...
def max_values(vi, hi, dtheta, M, rA, ymin, dt, shape, D, G, vwind, terrain, wa):
...
def go(shape, terrain, D, rA, M, vi, theta, ymin, latitude, vwind, wa, dt, dtheta):
    ...
    xmax_lst, ymax_lst, tmax_lst, angl_lst = max_values(vi, ymin, dtheta, M, rA, ymin, dt, shape, D, G, vwind, terrain, wa)
